        ...
        <div class="register-container">
            <div class="register-box">
                ...
                <form method="POST" action="" class="register-form">
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <div class="input-wrapper">
                                ...
                                <input type="text" id="nama" name="nama" placeholder="John Doe"
                    ...
                    <div class="form-group">
                        <div
                            style="background: #E8F4F8; border: 1px solid #B8E6F5; color: #0D5C75; padding: 14px; border-radius: 10px; font-size: 14px; display: flex; align-items: center; gap: 10px;">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                                <path
                                    d="M10 18C14.4183 18 18 14.4183 18 10C18 5.58172 14.4183 2 10 2C5.58172 2 2 5.58172 2 10C2 14.4183 5.58172 18 10 18Z"
                                    stroke="currentColor" stroke-width="1.5" />
                                <path d="M10 10V14M10 6H10.01" stroke="currentColor" stroke-width="2"
