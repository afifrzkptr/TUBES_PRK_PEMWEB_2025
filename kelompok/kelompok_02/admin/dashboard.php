                ...
                <div class="status-list">
                    ...
                    <div class="status-item">
                        ...
                        <div class="status-bar">
                            <div class="status-bar-fill <?php echo $badge_class; ?>" style="width: <?php echo $percentage; ?>%"></div>
                        </div>
                    </div>
                    <?php 
                        endforeach;
                    ...
                    <a href="patients.php" class="action-card">
                        <div class="icon">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                                <path d="M16 21V19C16 17.9391 15.5786 16.9217 14.8284 16.1716C14.0783 15.4214 13.0609 15 12 15H5C4.46957 15 3.96086 15.4214 3.58579 16.1716C3.21071 16.9217 3 17.9391 3 19V21" stroke="currentColor" stroke-width="2"/>
                    ...
                    <a href="doctors.php" class="action-card">
                        <div class="icon">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                                <path d="M17 21V19C17 16.7909 15.2091 15 13 15H5C2.79086 15 1 16.7909 1 19V21" stroke="currentColor" stroke-width="2"/>
                                <circle cx="9" cy="7" r="4" stroke="currentColor" stroke-width="2"/>
                                <path d="M23 11H17M20 8V14" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
                            </svg>
                        </div>
                        <h4>Tambah Dokter</h4>
                    </a>
                    ...
                    <a href="appointments.php" class="action-card">
                        <div class="icon">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                                ...
                                <path d="M12 14H12.01M16 14H16.01M8 14H8.01M12 18H12.01M16 18H16.01M8 18H8.01" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
                            </svg>
                        </div>
                    ...
                    <a href="medical_records.php" class="action-card">
                        <div class="icon">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                                ...
                                <path d="M14 2V8H20M12 11V17M9 14H15" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
                            </svg>
                        </div>
