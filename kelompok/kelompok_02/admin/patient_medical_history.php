...
@media print {
    .page-header, .print-button, .sidebar, .btn {
...
<div class="page-header">
    ...
    <div>
        <button class="btn btn-secondary" onclick="window.print()">
            <i data-lucide="printer" style="width: 16px; height: 16px; vertical-align: middle; color: #2F4156;"></i> Print
        </button>
        <a href="medical_records.php" class="btn btn-secondary">
            <i data-lucide="arrow-left" style="width: 16px; height: 16px; vertical-align: middle; color: #2F4156;"></i> Kembali
        </a>
    </div>
</div>
...
<div class="patient-header">
    ...
    <div class="patient-info">
        ...
        <div class="info-item">
            ...
            <span class="info-value"><?= $patient['birth_date'] ? date('d/m/Y', strtotime($patient['birth_date'])) : '-' ?></span>
        </div>
        <div class="info-item">
